...
required_paths=(
  ...
  "scripts/local/contracts/render-floe-profile.py"
  ...
  "scripts/azure/stack/infra-up.sh"
  "scripts/azure/stack/deploy-artifacts.sh"
  "scripts/azure/stack/setup.sh"
  ...
  "scripts/aws/stack/infra-up.sh"
  "scripts/aws/stack/deploy-artifacts.sh"
  "scripts/aws/stack/setup.sh"
