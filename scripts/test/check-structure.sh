...
required_paths=(
  ...
  "lakehouse_code/silver/sales/contracts/floe/order_revenue.yml"
  "lakehouse_code/silver/sales/contracts/floe/customer_health.yml"
  "lakehouse_code/silver/sales/contracts/floe/manifests/order_revenue.manifest.json"
  "lakehouse_code/silver/sales/contracts/floe/manifests/customer_health.manifest.json"
  "lakehouse_code/silver/supply_chain/__init__.py"
  "lakehouse_code/silver/supply_chain/contracts/floe/inventory_reliability.yml"
  "lakehouse_code/silver/supply_chain/contracts/floe/manifests/inventory_reliability.manifest.json"
  ...
  "lakehouse_code/dashboards/superset/order_revenue/metadata.yaml"
  "lakehouse_code/dashboards/superset/order_revenue/charts/Daily_Net_Revenue_1.yaml"
  "lakehouse_code/dashboards/superset/customer_health/metadata.yaml"
  "lakehouse_code/dashboards/superset/customer_health/charts/Health_Score_by_Segment_1.yaml"
  "lakehouse_code/dashboards/superset/inventory_reliability/metadata.yaml"
  "lakehouse_code/dashboards/superset/inventory_reliability/charts/Available_Inventory_by_Status_1.yaml"
  "scripts/README.md"
...
for dataset_path in sorted(Path("lakehouse_code").glob("dashboards/superset/*/datasets/*/*.yaml")):
...
for chart_path in sorted(Path("lakehouse_code").glob("dashboards/superset/*/charts/*.yaml")):
