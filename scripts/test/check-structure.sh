...
required_paths=(
  ...
  "domains/sales/reports/superset/dashboards/sales_gold_mart_overview.yaml"
  ...
  "scripts/local/build-superset-image.sh"
  "scripts/local/load-superset-image.sh"
  "scripts/local/superset-reports-deploy.sh"
  "scripts/local/superset-reports-export.sh"
)
