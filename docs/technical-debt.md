...
| Repository checks had split Python and shell ownership. | Resolved: `olf check` owns structure, component, contract, infrastructure, project-code, dbt, and lockfile checks; the structural check rejects tracked shell scripts. | Keep behavioral tests alongside the Python command services. | Delivered with ADR 0028 and issue #126. | Yes |
